...
gulp.task('js', ['common-js'], function() {
	return gulp.src([
		...
		'app/libs/smoothscroll-for-websites-master/SmoothScroll.js',
		...
		'app/libs/moment-timezone/builds/moment-timezone-with-data-2012-2022.min.js',
		'app/libs/slick/slick.min.js',
		'app/libs/slick-lightbox/dist/slick-lightbox.min.js',
		'app/libs/jquery-lazyload/jquery.lazyload.js',
		'app/libs/magnific-popup/dist/jquery.magnific-popup.min.js',
		'app/libs/mixitup/dist/mixitup.min.js',
		'app/libs/translucent-master/src/jquery.translucent.js',
...
gulp.task('deploy', function() {
	...
	var conn = ftp.create({
		host:      'test.romfam.ru',
		user:      'deploy@romfam.ru',
		password:  '25177152111523',
		parallel:  10,
		log: gutil.log
	});
